...
function tone(
  ac,
  { freq, duration, type = 'square', gain = 0.15, slideTo = null, delay = 0 },
) {
...
export const sfx = {
  move: () => beep({ freq: 220, duration: 0.04, type: 'square', gain: 0.1 }),
  rotate: () => beep({ freq: 330, duration: 0.05, type: 'square', gain: 0.1 }),
  ...
  perfectClear: () =>
    chord([
      { freq: 900, duration: 0.1, type: 'sine', gain: 0.16, delay: 0 },
      { freq: 1200, duration: 0.1, type: 'sine', gain: 0.16, delay: 0.09 },
  ...
  hostLost: () =>
    chord([
      { freq: 500, duration: 0.15, type: 'square', gain: 0.2, delay: 0 },
      { freq: 500, duration: 0.15, type: 'square', gain: 0.2, delay: 0.2 },
      { freq: 500, duration: 0.15, type: 'square', gain: 0.2, delay: 0.4 },
    ]),
};
