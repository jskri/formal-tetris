...
function applyEvent5(rs, e, params) {
  switch (e.kind) {
    case 'move':
      return oracle5.movePiece5(e.dy, e.dx, rs, params);
    case 'rotate':
      return oracle5.rotatePiece5(e.cw, rs, params);
    case 'fix':
      return oracle5.fixPiece5(e.bagNew, rs, params);
    case 'fall':
      return oracle5.fallStep5(e.bagNew, rs, params);
    case 'hold':
      return oracle5.holdPiece5(e.bagNew, rs, params);
    case 'drop':
      return oracle5.dropPiece5(e.bagNew, rs, params);
  }
}
