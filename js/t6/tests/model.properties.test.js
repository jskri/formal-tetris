...
function applyEvent6(rs, e, params) {
  switch (e.kind) {
    case 'move':
      return oracle6.movePiece6(e.dy, e.dx, rs, params);
    case 'rotate':
      return oracle6.rotatePiece6(e.cw, rs, params);
    case 'fix':
      return oracle6.fixPiece6(e.bagNew, rs, params);
    case 'fall':
      return oracle6.fallStep6(e.bagNew, rs, params);
    case 'hold':
      return oracle6.holdPiece6(e.bagNew, rs, params);
    case 'drop':
      return oracle6.dropPiece6(e.bagNew, rs, params);
    case 'kick':
      return oracle6.rotateKickPiece6(e.cw, rs, params);
  }
}
...
describe('T6 model.js properties', () => {
  test('rotateKickPiece and rotatePiece are exclusive: never both fire for the same input', () => {
    fc.assert(
      fc.property(bagArb, fc.boolean(), (initBag, cw) => {
